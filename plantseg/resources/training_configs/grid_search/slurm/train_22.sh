...
/g/kreshuk/wolny/workspace/pytorch-3dunet/train.py --config /g/kreshuk/wolny/workspace/plant-seg/plantseg/resources/training_configs/./grid_search/root/unet_bn_dice/config_train.yml
