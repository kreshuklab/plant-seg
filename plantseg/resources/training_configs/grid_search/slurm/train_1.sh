...
/g/kreshuk/wolny/workspace/pytorch-3dunet/train.py --config /g/kreshuk/wolny/workspace/plant-seg/plantseg/resources/training_configs/./grid_search/ovules/resunet_gn_bce/config_train.yml
