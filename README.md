...
* `confocal_unet_bce_dice_nuclei_stain_ds1x` - a variant of 3D U-Net trained on confocal images of _Arabidopsis_ ovules nuclei stain on original resolution, voxel size: (0.25x0.1625x0.1625 µm^3) (ZYX) with BCEDiceLoss
